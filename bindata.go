...
func dataTemplateIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/template/index.html", size: 1565, mode: os.FileMode(420), modTime: time.Unix(1479792091, 0)}
